-- Migration 001: languages table (DB-driven active-language registry).
-- Read by App\Services\I18n\LanguageService::getActiveLangs(). Adding a
-- language is just an INSERT here plus an app/Lang/{code}.php file — no
-- code changes.
...
INSERT IGNORE INTO `languages` (`code`, `name`, `native`, `flag`, `dir`, `is_active`, `sort_order`) VALUES
